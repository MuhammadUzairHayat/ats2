...
export default function PositionFormModal({
  ...
  const title = isEditMode ? "Edit Position" : "Add New Position";
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="relative w-full max-w-3xl h-5/6 mx-auto my-10 rounded-xl bg-white shadow-2xl overflow-hidden transform transition-transform duration-300">
        ...
        <div className="h-[calc(100%-60px)] md:h-[calc(100%-70px)] no-scrollbar overflow-y-auto">
